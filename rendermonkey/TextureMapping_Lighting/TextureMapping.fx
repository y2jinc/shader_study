...
VS_OUTPUT Effect_Group_1_TextureMapping_Pass_0_Vertex_Shader_vs_main( VS_INPUT Input )
{
   VS_OUTPUT Output;
...
float4 Effect_Group_1_TextureMapping_Pass_0_Pixel_Shader_ps_main(PS_INPUT Input) : COLOR0
{
...
technique TextureMapping
{
   pass Pass_0
   {
      VertexShader = compile vs_2_0 Effect_Group_1_TextureMapping_Pass_0_Vertex_Shader_vs_main();
      PixelShader = compile ps_2_0 Effect_Group_1_TextureMapping_Pass_0_Pixel_Shader_ps_main();
   }
